...
namespace AppAPIs.Controllers
{
    ...
    public class ScrappingController : ControllerBase
    {
                ...
                foreach (var kvp in rowData.Skip(1))
                {
                    ...
                    if (!string.IsNullOrEmpty(value))
                    {
                        ...
                        if (parts.Length >= 3)
                        {
                            ...
                            DateTime date = DateTime.ParseExact(dateString, "dd/MM", CultureInfo.InvariantCulture);
        ...
        public async Task<List<Dictionary<string, string>>> GetScrapeResult()
        {
            ...
            string cookieValue = "ASP.NET_SessionId=dgalaiikm2qv5izn5emsfvun; G_ENABLED_IDPS=google; G_AUTHUSER_H=0";
